...
--
-- Servidor: localhost
-- Tiempo de generación: 04-06-2013 a las 13:49:29
...
INSERT INTO `apartamentos` (`id_apartamento`, `nombre`, `id_apartamentos_tipo`, `id_direccion`, `id_empresa`, `id_moneda`, `horario_entrada`, `horario_salida`, `descripcion_corta`, `descripcion_larga`, `id_idioma`, `descripcion_servicios`, `descripcion_condiciones`, `tiempo_creacion`, `ultima_modificacion`, `estatus`, `id_usuario`, `id_contrato`, `tarifa_base`, `tarifa_semana`, `tarifa_mes`, `estadia_maxima`, `estadia_minima`, `huesped_adicional_apartir`, `huesped_adicional_costo`, `costo_limpieza`, `deposito_seguridad`, `precio_fin_semana`, `normas`, `tamanio`) VALUES
(1, 'Este es un super depa', 1, 1, 1, 2, NULL, NULL, 'Esta es una descripción corta', 'Esta es una descripción larga', 1, 'Descripción de servicios', 'Descripción de condiciones', '2013-05-29 22:43:00', '2013-05-29 22:43:00', 'activo', 1, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
(1, 'contrato comisionable 2012', '2013-05-29 22:40:37', '2013-05-29 22:40:37', '2013-05-29 22:40:25', '2014-05-29 22:40:28', 123, NULL);
...
INSERT INTO `cuentas` (`id_cuenta`, `iban`, `swif`, `id_moneda`, `id_empresa`) VALUES
(1, '364823648726374', '87236487236487236487', 1, 1);
...
INSERT INTO `direcciones` (`id_direccion`, `calle`, `numero`, `provincia`, `codigo_postal`, `id_pais`, `lat`, `lon`, `id_provincia`) VALUES
(1, 'Esta es una calle', '23D', 'España', '77500', 1, 40.423048425987, -3.65435172343746, 1);
...
INSERT INTO `empresas` (`id_empresa`, `nombre`, `apellido_paterno`, `apellido_materno`, `nombre_fiscal`, `cif`, `id_direccion`, `tiempo_creacion`, `ultima_modificacion`) VALUES
(1, 'Rubén', 'Velázquez', 'Calva', 'Listico''s Software', '2176381726387126387', 1, '2013-05-29 22:35:19', '2013-05-29 22:35:19');
...
(1, 724, 'Espana', 'ESP', 'ES', 724),
(2, 36, 'Australia', 'AUS', 'AU', 36),
(3, 484, 'Mexico', 'MEX', 'MX', 484),
...
INSERT INTO `usuarios` (`id_usuario`, `nombre`, `email`, `password`, `tiempo_creacion`, `ultima_modificacion`, `id_usuario_grupo`, `estatus`) VALUES
(1, 'Rubén', 'admin', 'admin', '2013-05-29 22:27:11', '2013-05-29 22:27:11', 1, NULL);
